...
WebUI.setText(findTestObject('Pages/Page_BuyPacket_Dicoding/promo'), 'testng')
...
WebUI.verifyElementText(findTestObject('Pages/Page_BuyPacket_Dicoding/warningPromoInValid'), 'Kode promo testng tidak ditemukan.')
