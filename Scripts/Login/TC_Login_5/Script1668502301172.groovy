...
WebUI.setEncryptedText(findTestObject('Pages/MyAccountPage/loginpage/password'), 'hCc8x1UqSX8vfSLAHukwvg==')

WebUI.delay(3)

WebUI.click(findTestObject('Pages/MyAccountPage/loginpage/button_Masuk'))

WebUI.verifyElementText(findTestObject('Pages/MyAccountPage/loginpage/Welcome'), 'Selamat dating Hana Maria Siahaan!')
